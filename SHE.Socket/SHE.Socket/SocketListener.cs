...
namespace SHE.GprsSocket
{
    public class SocketListener
    {
        ...
        /// operations and is invoked when an async accept operations completes.
        /// This is only when a new connection is being accept.
        /// Notice that Socket.AcceptAsync is returning a value of true, and
        /// raising the Completed event whan the AcceptAsync method completes.
        /// </summary>
